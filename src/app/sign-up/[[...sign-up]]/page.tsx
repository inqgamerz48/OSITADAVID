    ...
    <div className="min-h-[80vh] w-full flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      >
        <div className="backdrop-blur-xl bg-[#050505]/80 border border-white/10 p-10 shadow-2xl text-center">
          ...
          <p className="text-[10px] tracking-widest text-zinc-500 uppercase mb-8">Unlock exclusive access to drops and unreleased tracks</p>
          <p className="text-zinc-400 text-xs tracking-wider mb-8">Registration coming soon. Be the first to know when it drops.</p>
